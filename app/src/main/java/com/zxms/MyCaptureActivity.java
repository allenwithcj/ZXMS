...
public class MyCaptureActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static final int REQUEST_READ_EXTERNAL_STORAGE = 222;
        ...
        switch (v.getId()) {
            ...
            case R.id.linear2:
                if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.READ_EXTERNAL_STORAGE)
                    ...
                    ActivityCompat.requestPermissions(MyCaptureActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
        ...
        switch (requestCode){
            case REQUEST_READ_EXTERNAL_STORAGE:
                if(grantResults.length >0 &&grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(context,"您拒绝了权限",Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
