package com.zxms.imgselector.widget;
...
import com.zxms.R;
import com.zxms.imgselector.util.DeferredHandler;
import com.zxms.imgselector.util.ImageUtil;
...
//            photoView.setTag(imgPro);
            ImageUtil.load(context,imgPro.fullPath,photoView, R.drawable.ic_pig_rect);
//            if(mCallback!=null){
